<br><br>
   ...
   <tr><td width='50%' valign=top>
	   <table cellpadding="1" cellspacing="3" border="0" align="center" width='100%' height='100%' bgcolor='#F8F8F8' >	
			...
			<tr  height='45 px'>			
				<td  colspan="2" align='left' class="grayS" >Se você já é cadastrado</td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan=2 height="20"><a href='mvcphp.php?action=forgetPassword'>Esqueceu a senha ?</a></td>
			</tr>
...
informam empresários que querem investir,adquirir ou vender empresas</td>		
			...
			<tr>			
				<td bgcolor='white' height="20"><a href='mvcphp.php?action=condicao'> <img border="0" src="img/ico_cad.gif" align="right" width="113" height="25"></a></td>			
			</tr>	
