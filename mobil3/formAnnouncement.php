...
<div class="content-primary">
	<form action="index.php"  name="formAnnouncement" id="formAnnouncement" method="post">
		...
		<div data-role="fieldcontain">
		 ...
		 <input type='text' name='title' size='60' MAXLENGTH ="70" value="<?=$dataAnnouncement["title"]?>">
		</div>
	...
	<div data-role="fieldcontain">
			<fieldset data-role="controlgroup">
				<legend>Atividade da Empresa:</legend>
					<input type="radio" name="typecompany" id="radio-choice-1" value="Indústria" <?=$checkedI?> />
					<label for="radio-choice-1">Indústria</label>

					<input type="radio" name="typecompany" id="radio-choice-2" value="Comércio"  <?=$checkedC?>  />
					<label for="radio-choice-2">Comércio</label>

					<input type="radio" name="typecompany" id="radio-choice-3" value="Serviço"  <?=$checkedS?> />
	...
	<div data-role="fieldcontain">
		 ...
		 <textarea cols="40" rows="8" name="description" id="description"><?=$dataAnnouncement["description"]?></textarea>
	</div>


	<div data-role="fieldcontain">
		 <label for="name">Site da empresa: </label>
		 <input type='text' name='www' id="www"  value="<?=$dataAnnouncement["www"]?>">

	</div>

	<div data-role="fieldcontain">
		 <label for="name">Valor: </label>
		 <input type=text name='priceselling'  id="priceselling" value="<?=$price?>" onKeyPress="return(formataMoeda(this,'.',',',event));">
	 </div>


	<div data-role="fieldcontain">
	 <label for="name">No de Funcionários: </label>
	 <input type='text' name='numberemployee' id="numberemployee"  value="<?=$dataAnnouncement["numberemployee"]?>">
	</div>


	<div data-role="fieldcontain">
	 <label for="name">Condições para negociação: </label>
	 <input type='text' name='conditionpart' id="conditionpart"  value="<?=$dataAnnouncement["conditionpart"]?>">
	</div>
